...
#ifndef CLOG_VIN_SOCKET_H
#define CLOG_VIN_SOCKET_H
...
namespace vince {
    ...
    * @brief socket异常类
    */
    struct Vin_Socket_Exception : public Vin_Exception {
        explicit Vin_Socket_Exception(const std::string &buffer) : Vin_Exception(buffer) {};

        Vin_Socket_Exception(const std::string &buffer, int err) : Vin_Exception(buffer, err) {};
    };
    ...
    private:
        ...
        *
        */
        Vin_Socket(const Vin_Socket &tcSock)= delete;

        /**
        * @brief  no implementation.
        */
        Vin_Socket& operator=(const Vin_Socket &tcSock)= delete;
    ...
    public:
        ...
        *         生成新的.
        *
        * @param  iSocketType     socket方式SOCK_STREAM|SOCK_DGRAM
        * @param  iDomain         socket类型，缺省AF_INET，TCP/IP族
        * @throws                 Vin_Socket_Exception
        * @return
        */
        ...
        * @return
        */
        void bind(sockaddr *pstBindAddr, socklen_t iAddrLen);
        ...
        */
        Vin_Socket& accept(sockaddr *pstSockAddr, socklen_t &iSockLen);
        ...
        * @throws TC_Socket_Exception
        */
        void connect(sockaddr *pstServerAddr);
        ...
        *
         ...
         * @return int
         *
        int connectNoThrow( sockaddr *addr);
        ...
        * @return int        接收了的数据长度
        */
        int recvfrom(void *pvBuf, size_t iLen,  sockaddr *pstFromAddr, socklen_t &iFromLen, int iFlags = 0);
        ...
        * @return           int : >0 发送的数据长度 ;<=0, 出错
        */
        int sendto(const void *pvBuf, size_t iLen,  sockaddr *pstToAddr, socklen_t iToLen, int iFlags = 0);
        ...
        * @return
        */
        static void parseAddr(const std::string &sAddr,  in_addr &stAddr);
    ...
    protected:
        ...
        * @return int
        */
        int _connect( sockaddr *pstServerAddr, socklen_t serverLen);
        ...
        * @return
        */
        void _getPeerName( sockaddr *pstPeerAddr, socklen_t &iPeerLen);
        ...
        * @return
        */
        void _getSockName( sockaddr *pstSockAddr, socklen_t &iSockLen);
